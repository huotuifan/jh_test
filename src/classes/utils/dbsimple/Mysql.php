 ...
 */
class DbSimple_Mysql extends \utils\DbSimple_Generic_Database
{
    var $link;
    ...
    {
        $p = \utils\DbSimple_Generic::parseDSN($dsn);
...
class DbSimple_Mysql_Blob extends \utils\DbSimple_Generic_Blob
{
